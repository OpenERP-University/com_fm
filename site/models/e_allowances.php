	...
	public function getItems()
	{
		...
		foreach($items as $item){
			...
			$item->employee_guid = !empty($textValue) ? implode(', ', $textValue) : $item->employee_guid;
					...
					$item->option_allowance = JText::_('COM_FM_E_ALLOWANCES_OPTION_ALLOWANCE_OPTION_' . strtoupper($item->option_allowance));
					$item->option_study = JText::_('COM_FM_E_ALLOWANCES_OPTION_STUDY_OPTION_' . strtoupper($item->option_study));
					$item->option_break = JText::_('COM_FM_E_ALLOWANCES_OPTION_BREAK_OPTION_' . strtoupper($item->option_break));
}
