...
<script type="text/javascript">
    if (jQuery === 'undefined') {
        document.addEventListener("DOMContentLoaded", function(event) { 
            jQuery('#form-revenuededuction').submit(function(event) {
...
<div class="revenuededuction-edit front-end-edit">
    ...
    <form id="form-revenuededuction" action="<?php echo JRoute::_('index.php?option=com_fm&task=revenuededuction.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<input type="hidden" name="jform[time_update]" value="<?php echo $this->item->time_update; ?>" />
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-revenuededuction").appendChild(input);
                    });
                </script>
             <?php endif; ?>
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_fm&task=revenuedeductionform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
        
        <input type="hidden" name="option" value="com_fm" />
        <input type="hidden" name="task" value="revenuedeductionform.save" />
