 ...
 */
class FmControllerEmployeepayroll extends FmController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Employeepayroll', 'FmModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_fm') || $user->authorise('core.edit.state', 'com_fm')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_fm&view=employeepayrolls', false));
            } else {
