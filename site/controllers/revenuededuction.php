 ...
 */
class FmControllerRevenuededuction extends FmController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Revenuededuction', 'FmModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_fm') || $user->authorise('core.edit.state', 'com_fm')) {
            $model = $this->getModel('Revenuededuction', 'FmModel');
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_fm&view=revenuedeductions', false));
            } else {
    ...
    public function remove() {
        ...
        //Checking if the user can remove object
        $user = JFactory::getUser();
        if ($user->authorise($user->authorise('core.delete', 'com_fm'))) {
            $model = $this->getModel('Revenuededuction', 'FmModel');
