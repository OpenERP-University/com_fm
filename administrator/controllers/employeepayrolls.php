...
/**
 * Employeepayrolls list controller class.
 */
class FmControllerEmployeepayrolls extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function getModel($name = 'employeepayroll', $prefix = 'FmModel', $config = array())
	{
