...
<script type="text/javascript">
    ...
    {
        if (task == 'employeepayroll.cancel') {
            Joomla.submitform(task, document.getElementById('employeepayroll-form'));
        }
        else {
            
            if (task != 'employeepayroll.cancel' && document.formvalidator.isValid(document.id('employeepayroll-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_fm&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="employeepayroll-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_FM_TITLE_EMPLOYEEPAYROLL', true)); ?>
        <div class="row-fluid">
            <div class="span10 form-horizontal">
				...
				<input type="hidden" name="jform[employee_guid]" value="<?php echo $this->item->employee_guid; ?>" />
				<input type="hidden" name="jform[department_guid]" value="<?php echo $this->item->department_guid; ?>" />
				<input type="hidden" name="jform[payroll]" value="<?php echo $this->item->payroll; ?>" />
