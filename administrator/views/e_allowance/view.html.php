 ...
 * View to edit
 */
class FmViewE_allowance extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FM_TITLE_E_ALLOWANCE'), 'e_allowance.png');

        // If not checked out, can save the item.
        if (!$checkedOut && ($canDo->get('core.edit') || ($canDo->get('core.create')))) {

            JToolBarHelper::apply('e_allowance.apply', 'JTOOLBAR_APPLY');
            JToolBarHelper::save('e_allowance.save', 'JTOOLBAR_SAVE');
        }
        ...
        if (empty($this->item->id)) {
            JToolBarHelper::cancel('e_allowance.cancel', 'JTOOLBAR_CANCEL');
			 ...
			 if ($this->state->params->get('save_history', 0) && $user->authorise('core.edit')) {
                JToolbarHelper::versions('com_fm.e_allowance', $this->item->id);
            }
            JToolBarHelper::cancel('e_allowance.cancel', 'JTOOLBAR_CLOSE');
        }
    }
