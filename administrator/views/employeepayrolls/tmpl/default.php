...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_fm&task=employeepayrolls.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'employeepayrollList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="employeepayrollList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'employeepayrolls.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
