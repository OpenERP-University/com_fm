...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_fm&task=revenuedeductions.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'revenuedeductionList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="revenuedeductionList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'revenuedeductions.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
                    
				<td>

                                    <a href = "<?php echo JRoute::_('index.php?option=com_fm&view=revenuededuction&layout=edit&id='.$item->id); ?>" >	<?php echo $item->employee_guid; ?></a>
				</td>
				<td>
