 ...
 * Fm model.
 */
class FmModelE_allowance extends JModelAdmin
{
	/**
	...
	public $typeAlias = 'com_fm.e_allowance';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_fm.e_allowance', 'e_allowance', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id)) {
			...
			if (@$table->ordering === '') {
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__fm_e_allowance');
				$max = $db->loadResult();
