 ...
 * Fm model.
 */
class FmModelRevenuededuction extends JModelAdmin {
    ...
    public $typeAlias = 'com_fm.revenuededuction';
    ...
    public function getForm($data = array(), $loadData = true) {
        ...
        // Get the form.
        $form = $this->loadForm('com_fm.revenuededuction', 'revenuededuction', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function prepareTable($table) {
        ...
        if (empty($table->id)) {
            ...
            if (@$table->ordering === '') {
                $db = JFactory::getDbo();
                $db->setQuery('SELECT MAX(ordering) FROM #__fm_revenue_deduction');
                $max = $db->loadResult();
